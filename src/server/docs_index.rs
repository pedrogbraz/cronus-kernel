...
fn section_entries() -> Vec<Value> {
    vec![
        section_entry(
            "section-hero",
            "Hero Section",
            "Full-width hero with title, subtitle, CTA buttons, and optional image/video",
            &[
                "hero", "title", "subtitle", "cta", "image", "video", "gradient",
            ],
            &["section-cta", "section-features"],
        ),
        section_entry(
            "section-features",
            "Features Section",
            "Grid of feature cards with icon, title, and description",
            &["features", "icon", "grid", "card", "columns"],
            &["section-bento", "section-features-split"],
        ),
        section_entry(
            "section-pricing",
            "Pricing Section",
            "Pricing table with plans, tiers, and comparison",
            &[
                "pricing", "plan", "tier", "price", "billing", "monthly", "yearly",
            ],
            &["section-checkout", "section-cta"],
        ),
        section_entry(
            "section-cta",
            "Call to Action",
            "Prominent call-to-action block with button and description",
            &["cta", "button", "action", "convert"],
        ...
        section_entry(
            ...
            &["faq", "question", "answer", "accordion", "expand"],
            &["section-accordion"],
        ),
        section_entry(
            "section-testimonial",
            "Testimonial Section",
            "Customer testimonials with avatar, name, role, and quote",
            &["testimonial", "review", "quote", "avatar", "rating"],
            &["section-trusted"],
        ),
        section_entry(
            "section-trusted",
            "Trusted By Section",
            "Logo bar of trusted companies/partners",
            &["trusted", "logo", "partner", "brand", "client"],
            &["section-testimonial"],
        ),
        section_entry(
            "section-topbar",
            ...
            &["topbar", "nav", "navigation", "logo", "menu", "header"],
            &["section-sidebar", "section-footer"],
        ),
        section_entry(
            "section-sidebar",
            "Sidebar Section",
            "Side navigation panel with links and sections",
            &["sidebar", "nav", "menu", "panel", "drawer"],
            &["section-topbar", "layout-block"],
        ),
        section_entry(
            "section-breadcrumb",
            "Breadcrumb Section",
            ...
            &["section-topbar", "section-page-header"],
        ),
        section_entry(
            "section-tabs",
            "Tabs Section",
            "Tabbed content switcher",
            &["tabs", "tab", "switch", "panel"],
            &["section-accordion"],
        ),
        section_entry(
            "section-footer",
            "Footer Section",
            "Page footer with links, copyright, and social",
            &["footer", "links", "copyright", "social", "bottom"],
            &["section-topbar"],
        ),
        section_entry(
            "section-page-header",
            "Page Header Section",
            "Page title area with breadcrumb and actions",
            &["page-header", "title", "breadcrumb", "actions"],
            &["section-topbar", "section-breadcrumb"],
        ),
        section_entry(
            "section-links",
            "Links Section",
            ...
            &["links", "link", "nav", "url"],
            &["section-footer", "section-sidebar"],
        ),
        section_entry(
            "section-table",
            "Table Section",
            "Data table with columns, sorting, and pagination",
            &["table", "columns", "sort", "pagination", "rows", "data"],
            &["section-activity-table", "section-filters"],
        ),
        section_entry(
            "section-chart",
            "Chart Section",
            "Data visualization chart (bar, line, pie, area)",
            &[
                "chart",
                "bar",
                "line",
            ...
            &["section-kpi", "section-stat-cards"],
        ),
        section_entry(
            "section-kpi",
            "KPI Section",
            "Key performance indicator cards with values and trends",
            &["kpi", "metric", "value", "trend", "indicator", "stats"],
            &["section-stat-cards", "section-chart"],
        ),
        section_entry(
            "section-stat-cards",
            "Stat Cards Section",
            "Grid of statistic cards with labels and values",
            &["stat-cards", "stats", "metric", "card", "number"],
            &["section-kpi", "section-chart"],
        ),
        section_entry(
            "section-timeline",
            "Timeline Section",
            "Chronological event timeline",
            &["timeline", "event", "chronological", "history", "date"],
            &["section-activity-table", "section-progress"],
        ),
        section_entry(
            "section-progress",
            "Progress Section",
            "Progress bars or step indicators",
            &["progress", "bar", "step", "percentage", "completion"],
            &["section-timeline", "section-kpi"],
        ),
        section_entry(
            "section-kanban",
            "Kanban Section",
            "Kanban board with draggable columns and cards",
            &["kanban", "board", "column", "card", "drag", "status"],
            &["section-table", "section-status-card"],
        ),
        section_entry(
            "section-form",
            "Form Section",
            "Input form with fields, validation, and submit",
            &[
                "form",
                "input",
                "field",
            ...
            &["section-checkout", "page-block"],
        ),
        section_entry(
            "section-checkout",
            "Checkout Section",
            "Payment checkout flow with order summary",
            &["checkout", "payment", "order", "cart", "buy", "stripe"],
            &["section-form", "section-pricing"],
        ),
        section_entry(
            "section-card",
            "Card Section",
            "Content card with image, title, and description",
            &["card", "image", "content", "tile"],
            &["section-product-grid", "section-bento"],
        ),
        section_entry(
            "section-product-grid",
            "Product Grid Section",
            "Grid of product cards with price and image",
            &["product-grid", "product", "grid", "shop", "price", "image"],
        ...
        section_entry(
            ...
            &["bento", "grid", "asymmetric", "layout", "masonry"],
        ...
        section_entry(
            ...
            &["team-list", "team", "member", "avatar", "role"],
            &["section-card", "section-testimonial"],
        ),
        section_entry(
            "section-status-card",
            "Status Card Section",
            "Status indicator cards with state and color",
            &["status-card", "status", "indicator", "state", "badge"],
            &["section-kpi", "section-kanban"],
        ),
        section_entry(
            "section-activity-table",
            "Activity Table Section",
            "Recent activity log table",
            &["activity-table", "activity", "log", "recent", "event"],
            &["section-table", "section-timeline"],
        ),
        section_entry(
            "section-alert",
            "Alert Section",
            "Alert/banner messages (info, warning, error, success)",
            &[
                "alert", "banner", "message", "warning", "error", "info", "success",
            ],
            &["section-toast", "section-info-bar"],
        ),
        section_entry(
            "section-modal",
            "Modal Section",
            "Dialog overlay with content and actions",
            &["modal", "dialog", "overlay", "popup"],
            &["section-sheet", "section-form"],
        ),
        section_entry(
            "section-sheet",
            "Sheet Section",
            "Slide-in bottom/side panel",
            &["sheet", "panel", "slide", "drawer", "bottom-sheet"],
            &["section-modal", "section-sidebar"],
        ),
        section_entry(
            "section-toast",
            "Toast Section",
        ...
        section_entry(
            ...
            &["empty", "no-data", "placeholder", "illustration"],
            &["section-skeleton", "section-error"],
        ),
        section_entry(
            "section-error",
            "Error Section",
            "Error state display with retry action",
            &["error", "failure", "retry", "500", "crash"],
            &["section-not-found", "section-empty"],
        ),
        section_entry(
            "section-not-found",
            "Not Found Section",
            "404 not found page content",
            &["not-found", "404", "missing", "page"],
            &["section-error", "section-empty"],
        ),
        section_entry(
            "section-command",
            "Command Palette Section",
            "Command palette / search overlay (Cmd+K style)",
            &["command", "palette", "search", "cmd-k", "spotlight"],
            &["section-modal", "section-filters"],
        ),
        section_entry(
            "section-dropdown",
            "Dropdown Section",
            "Dropdown menu with options",
            &["dropdown", "menu", "select", "option", "popover"],
            &["section-command", "section-tabs"],
        ),
        section_entry(
            "section-notifications",
            "Notifications Section",
            "Notification feed/list",
            &["notifications", "feed", "inbox", "bell", "unread"],
            &["section-activity-table", "section-toast"],
        ),
        section_entry(
            "section-dark-mode",
            "Dark Mode Toggle Section",
            "Theme toggle between light and dark modes",
            &["dark-mode", "toggle", "theme", "light", "switch"],
            &["style-block"],
        ),
        section_entry(
            "section-layout",
            "Layout Section",
            "Generic layout container (flex, grid)",
            &["layout", "container", "flex", "grid", "wrapper"],
            &["layout-block"],
        ),
        section_entry(
            "section-edge",
            "Edge Section",
            "Edge-to-edge full-bleed section",
            &["edge", "full-bleed", "full-width", "bleed"],
            &["section-hero"],
        ),
        section_entry(
            "section-accordion",
            ...
            &["accordion", "collapse", "expand", "panel", "toggle"],
        ...
        section_entry(
            ...
            &["pagination", "page", "next", "previous", "pager"],
            &["section-table", "section-filters"],
        ),
        section_entry(
            "section-filters",
            "Filters Section",
            "Data filter controls (search, select, date range)",
            &[
                "filters",
                "filter",
                "search",
            ...
            &["section-table", "section-pagination"],
        ),
        section_entry(
            "section-promo",
            "Promo Section",
            "Promotional banner or highlight",
            &["promo", "banner", "promotion", "highlight", "sale"],
            &["section-hero", "section-cta"],
        ),
        section_entry(
            "section-info-bar",
            "Info Bar Section",
            "Informational top/bottom bar",
            &["info-bar", "announcement", "bar", "notice"],
            &["section-alert", "section-topbar"],
        ),
        section_entry(
            "section-features-split",
            "Features Split Section",
            "Alternating image+text feature blocks",
            &["features-split", "split", "alternating", "image-text"],
            &["section-features", "section-hero"],
        ),
        section_entry(
            "section-policies",
            "Policies Section",
            "Legal/policy content blocks (terms, privacy)",
            &["policies", "terms", "privacy", "legal", "tos"],
            &["section-footer", "section-accordion"],
        ),
        section_entry(
            "section-loading",
            "Loading Section",
            "Full loading state with spinner/progress",
        ...
        section_entry(
            "section-stats",
            "Stats Section",
            "Statistics display (alias for kpi/stat-cards)",
...
fn cli_entries() -> Vec<Value> {
    vec![
        cli_entry(
            "cli-run",
            "cronus run",
            "Start the dev server with HMR and auto-reload",
            &["run", "start", "dev", "server", "--port", "--debug"],
        ),
        cli_entry(
            "cli-debug",
            "cronus debug",
            "Start in debug mode with Zeus tracer and detailed logging",
            &["debug", "trace", "verbose", "inspect"],
        ),
        cli_entry(
            "cli-build",
            "cronus build",
            "Compile .cronus files to optimized production output",
            &["build", "compile", "production", "--release", "--output"],
        ),
        cli_entry(
            "cli-parse",
            "cronus parse",
            "Parse .cronus file and output AST as JSON",
            &["parse", "ast", "syntax", "tree", "--json"],
        ),
        cli_entry(
            "cli-new",
            "cronus new",
            "Scaffold a new CRONUS project from template",
            &["new", "init", "scaffold", "create", "project"],
        ),
        cli_entry(
            "cli-seed",
            "cronus seed",
            "Populate database with sample data from entity definitions",
            &["seed", "data", "populate", "sample", "fake"],
        ),
        cli_entry(
            "cli-deploy",
            "cronus deploy",
            "Deploy app to production (Docker/systemd/cloud)",
            &["deploy", "production", "docker", "ship"],
        ),
        cli_entry(
            "cli-doctor",
            "cronus doctor",
            "Diagnose environment and configuration issues",
            &["doctor", "diagnose", "check", "health", "fix"],
        ),
        cli_entry(
            "cli-stats",
            "cronus stats",
            "Show project statistics (entities, pages, sections, lines)",
            &["stats", "info", "count", "summary"],
        ),
        cli_entry(
            "cli-export",
            "cronus export",
            "Export app as standalone HTML/JSON package",
            &["export", "html", "json", "package", "bundle"],
        ),
        cli_entry(
            "cli-test",
            "cronus test",
            "Run inline test blocks and report results",
            &["test", "assert", "spec", "check"],
        ),
        cli_entry(
            "cli-compose",
            "cronus compose",
            "Generate .cronus files from templates (SaaS, landing, dashboard)",
            &["compose", "generate", "template", "scaffold", "--template"],
        ),
        cli_entry(
            "cli-generate",
            "cronus generate",
            "Generate entity/page/component scaffolds",
            &["generate", "scaffold", "entity", "page", "component"],
        ),
        cli_entry(
            "cli-dump",
            "cronus dump",
            "Reverse-engineer HTML into .cronus section primitives",
            &["dump", "reverse", "html", "convert", "import"],
        ),
        cli_entry(
            "cli-clone",
            "cronus clone",
            "Clone an existing CRONUS app as starting point",
            &["clone", "copy", "fork", "duplicate"],
        ),
        cli_entry(
            "cli-validate",
            "cronus validate",
            "Validate .cronus syntax and semantic rules",
            &["validate", "lint", "check", "syntax"],
        ),
        cli_entry(
            "cli-graph",
            "cronus graph",
            "Generate entity relationship graph visualization",
            &["graph", "erd", "diagram", "relationship", "visualize"],
        ),
        cli_entry(
            "cli-brief",
            "cronus brief",
            "Generate AI-readable project summary for context",
            &["brief", "summary", "context", "ai", "overview"],
        ),
        cli_entry(
            "cli-context",
            "cronus context",
            "Export full project context for AI assistants",
            &["context", "export", "ai", "prompt"],
        ),
        cli_entry(
            "cli-sync",
            "cronus sync",
            "Sync shared entities from remote sources",
            &["sync", "remote", "shared", "pull"],
        ),
        cli_entry(
            "cli-handoff",
            "cronus handoff",
            "Generate handoff document for team collaboration",
            &["handoff", "document", "team", "transfer"],
        ),
        cli_entry(
            "cli-lease",
            "cronus lease",
            "Manage entity field leases for concurrent editing",
            &["lease", "lock", "concurrent", "edit"],
        ),
        cli_entry(
            "cli-drift",
            "cronus drift",
            "Detect schema drift between .cronus and database",
            &["drift", "schema", "migration", "diff"],
        ),
        cli_entry(
            "cli-spec",
            "cronus spec",
            "Generate OpenAPI/Swagger spec from API definitions",
            &["spec", "openapi", "swagger", "api-doc"],
        ),
        cli_entry(
            "cli-segment",
            "cronus segment",
            "Analyze and segment app into microservices",
            &["segment", "microservice", "split", "analyze"],
        ),
        cli_entry(
            "cli-reconcile",
            "cronus reconcile",
            "Reconcile field types between entities and database",
            &["reconcile", "field", "type", "database", "fix"],
        ),
        cli_entry(
            "cli-review",
            "cronus review",
            "AI-assisted code review of .cronus files",
            &["review", "ai", "feedback", "quality"],
        ),
        cli_entry(
            "cli-timeline",
            "cronus timeline",
            "Show project change timeline",
            &["timeline", "history", "changelog", "changes"],
        ),
        cli_entry(
            "cli-status",
            "cronus status",
            "Show current project status and health",
            &["status", "info", "state", "overview"],
        ),
        cli_entry(
            "cli-changelog",
            "cronus changelog",
            "Generate changelog from project history",
            &["changelog", "release", "notes", "version"],
        ),
        cli_entry(
            "cli-memory",
            "cronus memory",
            "Manage persistent project memory for AI context",
            &["memory", "remember", "context", "persist"],
        ),
        cli_entry(
            "cli-verify-audit",
            "cronus verify-audit",
            "Verify audit results against fidelity threshold",
            &["verify-audit", "fidelity", "check", "threshold"],
        ),
        cli_entry(
            "cli-audit",
            "cronus audit",
            "Run full fidelity audit comparing rendered output to source",
            &["audit", "fidelity", "compare", "measure"],
        ),
        cli_entry(
            "cli-help",
            "cronus help",
            "Show help for all commands and options",
            &["help", "usage", "commands", "manual"],
        ),
    ]
}
...
fn backend_entries() -> Vec<Value> {
    vec![
        entry(
            ...
            "backend",
            "reference",
            "Authentication endpoints: login, signup, me, logout with JWT tokens",
            &["auth-block", "crud-endpoints"],
        ),
        entry(
            "crud-endpoints",
            ...
            "backend",
            "reference",
            "Auto-generated CRUD endpoints for every entity: GET/POST/PATCH/DELETE",
        ...
        entry(
            ...
            &["/api/health", "/api/_health", "status", "uptime", "version"],
            "backend",
            "reference",
        ...
        entry(
            ...
            &["/api/schema", "entities", "fields", "types", "introspect"],
            "backend",
            "reference",
            "Returns full app schema: entities, fields, types, and relations as JSON",
        ...
        entry(
            ...
            "/docs#seed-endpoint",
            &["backend", "seed", "data"],
            &["/api/_seed", "populate", "sample", "fake", "dev"],
            "backend",
            "reference",
            "POST to populate database with generated sample data for development",
            &["cli-seed"],
        ),
        entry(
            "sse-endpoint",
            ...
            "backend",
            "reference",
            "Server-Sent Events endpoint for real-time data push to clients",
            &["binding-syntax"],
        ),
        entry(
            "graphql-endpoint",
            "GraphQL Endpoint",
            "/docs#graphql-endpoint",
            ...
            "backend",
            "reference",
            "GraphQL API with auto-generated queries, mutations, and playground UI",
            &["schema-endpoint", "crud-endpoints"],
        ),
        entry(
            "audit-endpoints",
            "Audit Endpoints",
            "/docs#audit-endpoints",
            &["backend", "audit", "fidelity"],
            &[
                "/api/audit/trigger",
                "/api/audit/results",
                "/api/audit/verify",
            ...
            "backend",
            "reference",
            "Audit system endpoints: trigger audit, retrieve results, verify fidelity scores",
            &["audit-system", "cli-audit"],
        ),
        entry(
            "hydra-endpoints",
            "Hydra Endpoints",
            "/docs#hydra-endpoints",
            &["backend", "hydra", "evolution"],
            &[
                "/api/hydra/registry",
                "/api/hydra/evolve",
                "/api/hydra/candidates",
                "trust",
                "promote",
            ],
            "backend",
            "reference",
            "Hydra block evolution endpoints: registry, evolve cycle, candidate blocks",
            &["hydra-system", "hydra-dashboard"],
        ),
        entry(
            "brain-endpoints",
            "Brain Endpoints",
            "/docs#brain-endpoints",
            &["backend", "brain", "ai"],
            &[
                "/api/brain/stats",
                "/api/brain/suggest",
            ...
            "backend",
            "reference",
            "Brain learning system endpoints: stats and AI-powered suggestions",
            &[],
        ),
        entry(
            "payment-endpoints",
            "Payment Endpoints",
            "/docs#payment-endpoints",
            ...
            "backend",
            "reference",
            "Payment processing endpoints: checkout creation, payment status, webhooks",
        ...
        entry(
            ...
            "backend",
            "reference",
            "AI Context Protocol endpoint: returns structured project context for LLM consumption",
            &["docs-index"],
        ),
        entry(
            "docs-index",
            ...
            "backend",
            "reference",
            "AI-optimized documentation index with search and tag filtering (this endpoint)",
...
fn advanced_dashboard_entries() -> Vec<Value> {
    vec![
        entry(
            ...
            "advanced",
            "reference",
            "Auto-generated API documentation page from entity and route definitions",
        ...
        entry(
            ...
            "advanced",
            "reference",
            "Auto-generated design system showing all section types with live preview",
        ...
        entry(
            ...
            "advanced",
            "reference",
            "Interactive entity relationship diagram with D3.js visualization",
        ...
        entry(
            ...
            "/blocks",
            &["advanced", "blocks", "3d"],
            &["blocks", "explorer", "3d", "browser", "interactive"],
            "advanced",
            "reference",
            "3D block browser for exploring all defined blocks and their relationships",
            &["hydra-dashboard"],
        ),
        entry(
            "zeus-tracer",
            ...
            "advanced",
            "reference",
            "Request tracing dashboard showing method, path, status, duration, and query count",
            &["health-endpoints"],
        ),
        entry(
            "trust-dashboard",
            ...
            &["trust", "profile", "score", "reputation", "verification"],
            "advanced",
            "reference",
            "Trust profile dashboard showing entity trust scores and verification status",
            &["hydra-system"],
        ),
        entry(
            "hydra-dashboard",
            ...
            "advanced",
            "reference",
            "Hydra evolution cycle dashboard: view candidates, promote blocks, track trust",
