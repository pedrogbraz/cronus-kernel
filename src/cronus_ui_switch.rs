...
pub fn render(comp: &ComponentNode) -> String {
    ...
    let mut attrs = format!(
        "type=\"button\" data-slot=\"switch\" role=\"switch\" aria-checked=\"{aria_checked}\" data-state=\"{state}\""
    );
    if disabled {
...
mod tests {
    ...
    fn root_is_button_not_label_checkbox() {
        ...
        assert!(html.contains("<span data-slot=\"switch-thumb\"></span>"));
    ...
    fn chrome_uses_cronus_tokens() {
        ...
        assert!(css.contains("[data-slot=\"switch-thumb\"]"));
