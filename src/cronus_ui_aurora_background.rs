...
//! `data-slot="aurora-blob"` divs + relative children wrapper (label).
//! CSS blobs/keyframes live in COMPONENT_CHROME. Zero JS, no inline style.
...
pub fn render(comp: &ComponentNode) -> String {
    format!(
        "<div data-slot=\"aurora-background\"><div aria-hidden=\"true\"><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div></div><div>{}</div></div>",
        label_of(comp)
    )
}
...
mod tests {
    ...
    fn root_wraps_label_text_not_fx_title_box() {
        ...
        assert_eq!(
            html,
            "<div data-slot=\"aurora-background\"><div aria-hidden=\"true\"><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div></div><div>Aurora</div></div>"
        );
        assert!(html.starts_with("<div "));
        assert!(html.contains("data-slot=\"aurora-background\""));
        assert!(html.contains(">Aurora</div></div>"));
        assert_eq!(html.matches("data-slot=\"aurora-blob\"").count(), 3);
    ...
    fn label_is_escaped() {
        ...
        assert_eq!(
            html,
            "<div data-slot=\"aurora-background\"><div aria-hidden=\"true\"><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div><div data-slot=\"aurora-blob\"></div></div><div>A &lt;B&gt; &amp; &quot;C&quot;</div></div>"
        );
    ...
    fn chrome_aurora_via_css() {
        ...
        assert!(css.contains("[data-slot=\"aurora-background\"]"));
