...
//! `<div data-slot="area-chart">` wrapping an SVG area series.
...
pub fn render(comp: &ComponentNode) -> String {
    ...
    format!(
        "<div data-slot=\"area-chart\" role=\"img\" aria-label=\"{label}\"><svg viewBox=\"0 0 200 100\" aria-hidden=\"true\"><path d=\"{d}\" fill=\"var(--cronus-primary)\"></path><polyline fill=\"none\" stroke=\"var(--cronus-primary)\" stroke-width=\"2\" points=\"{pts}\"></polyline></svg></div>"
    )
}
...
mod tests {
    ...
    #[test]
    fn root_is_div_with_svg_area_not_figure() {
        let html = render(&stub("area-chart", "Revenue"));
        assert!(html.starts_with("<div data-slot=\"area-chart\""));
