...
//! The previous / next slide arrows are JS-only (they scroll the strip),
//! rendered `disabled` with the idle look; the strip scrolls natively.
//!
